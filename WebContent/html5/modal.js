...
Example.Modal.prototype = {
    initialize : function(hash) {
        ...
        this.width = 50; // 콘텐츠 레이어 너비
        this.height = 50; // 콘텐츠 레이어 높이
        this.c_width = 50; // body 화면 너비
        this.c_height = 50; // body 화면 높이
        this.s_width = 50; // body 전체 너비
        this.s_height = 50; // body 전체 높이
